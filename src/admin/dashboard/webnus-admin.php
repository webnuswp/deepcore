...
class Deep_Admin {
	...
	public function admin_menus() {
		$menu_visiblity	= array(
			...
			'getting_started' => !empty( self::$deep_options['deep_theme_menus']['getting_started'] ) ? self::$deep_options['deep_theme_menus']['getting_started'] : '0',
		...
		call_user_func_array( 'add' . '_sub' . 'menu_' . 'page', array(
			'wn-admin-welcome',
			esc_html__( 'Getting Started', 'deep' ),
			esc_html__( 'Getting Started', 'deep' ),
			'manage_options',
			'wn-admin-getting-started',
		...
		if ( $menu_visiblity['getting_started'] == '1' ) {
			remove_submenu_page( 'wn-admin-welcome', 'wn-admin-getting-started' );
		}
	...
	public function screen_video_tutorial() {
		echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>';
		include_once( '_partials/getting-started.php' );
	}
