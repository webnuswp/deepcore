	...
	$meta_boxes[] = array(
		...
		'fields'		=> array(
			...
			array(
				...
				'type'		=> 'select',
				'options'	=> array(
					'themeopts' => esc_attr__( 'Use Default Theme Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'     => array(
					'type0' => esc_attr__( 'Use Default Theme Options', 'deep' ),
	...
	$meta_boxes[] = array(
		...
		'fields'		=> array(
			array(
				...
				'type'	=> 'select',
				'options'     => array(
					'none' 	=> esc_attr__( 'Use Default Theme Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'	=> array(
					'themeoptions'	=> esc_attr__( 'Use Default Theme Options', 'deep' ),
			...
			array(
				...
				'type'	=> 'select',
				'options'	=> array(
					'inherit'	=> esc_attr__( 'Use Default Theme Options', 'deep' ),
					'none'		=> esc_attr__( 'None', 'deep' ),
					'right'		=> esc_attr__( 'Right', 'deep' ),
					'left'		=> esc_attr__( 'Left', 'deep' ),
		...
		'fields'		=> array(
			...
			array(
				...
				'options'  	=> array(
					...
					'inherit'    => esc_html__( 'Use Default Theme Options', 'deep' ),
