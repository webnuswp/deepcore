...
function load_webnus_woocommerce() {
	...
	if ( $deep_options['deep_shop_style'] == '0' ) {
		include_once DEEP_COMPONENTS_DIR . 'woocommerce/woo-integration.php';
	} else {
		include_once DEEP_COMPONENTS_DIR . 'woocommerce/woo-default.php';
		add_filter(
			'body_class',
			function( $classes ) {
...
function deep_admin_bar_link() {
	...
	$menu_visiblity        = array(
		...
		'getting-started' => ! empty( $deep_options['deep_theme_menus']['getting-started'] ) ? $deep_options['deep_theme_menus']['getting-started'] : '0',
	...
	if ( $menu_visiblity['getting-started'] != '1' ) {
		$wp_admin_bar->add_menu(
			array(
				'id'     => 'wn_fourth_menu_item',
				'parent' => 'wn_main_menu_item',
				'title'  => 'Getting started',
				'href'   => $admin_url . 'wn-admin-getting-started',
			)
		);
	}
