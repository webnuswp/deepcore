...
if ( ! function_exists( 'deep_woo_scripts' ) ) {
    ...
    function deep_woo_scripts() {
        ...
        wp_enqueue_style( 'deep-woocommerce-style', DEEP_COMPONENTS_URL . 'woocommerce/assets/woocommerce.css' );
        wp_enqueue_script( 'deep-woocommerce-script', DEEP_COMPONENTS_URL . 'woocommerce/assets/woocommerce.js', array( 'jquery' ), null, true );
...
function deep_woo_yith_woocompare_popup_head() {
    echo '<link rel="stylesheet" href="' . DEEP_URL . 'src/components/woocommerce/assets/woocommerce.css"/>';
...
if ( ! function_exists('deep_woo_single_upsell_product') ) {
    function deep_woo_single_upsell_product() {
        ...
        wp_enqueue_script( 'deep-owl-carousel' );
        wp_enqueue_script(
            'deep_woo_single_related',
            DEEP_COMPONENTS_URL . 'woocommerce/assets/related-carousel.js',
            [],
            'DEEP_VERSION',
            'true'
        );
